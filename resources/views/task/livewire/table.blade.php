<div>
    ...
    <table class="table-auto w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400" >
        ...
        @forelse($tasks as $task)
            <tr class=" bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                <td scope="row"
                    class="max-w-sm px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    {{ \Illuminate\Support\Str::words($task->description, 7) }}
                </td>
                <th scope=""
                ...
                <td class="px-6 py-4">
                    <x-secondary-button wire:navigate href="{{route('project-show', $task->id)}}">
                        {{ __('Start execution') }}
                    </x-secondary-button>
                    <x-button wire:navigate href="{{route('project-show', $task->id)}}">
                        {{ __('Show task') }}
                    </x-button>
    ...
    <div wire:loading.flex class="flex items-center justify-center w-56 h-56 mt-2">
        <div role="status">

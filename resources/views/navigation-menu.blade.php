<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link wire:navigate href="{{ route('tasks') }}" :active="request()->routeIs('tasks')">
                        {{ __('Tasks') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link wire:navigate href="{{ route('projects') }}" :active="request()->routeIs('projects')">
                {{ __('Projects') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link wire:navigate href="{{ route('tasks') }}" :active="request()->routeIs('tasks')">
                {{ __('Tasks') }}
            </x-responsive-nav-link>
        </div>
